...
const SECTIONS = [
  ...
  },
  {
    ...
    sub: "9 Proven Setup Frameworks",
    desc: "Detailed interactive playbooks for ORB, VWAP Reclaim, Liquidity Sweep Reversal, Break & Retest, FVG Reclaim, Order Block Bounce, Trend Pullback, Gap Fill, and Box Method. Each includes setup rules, entry framework, invalidation, checklist, and common mistakes.",
    color: "#f59e0b",
    stats: ["9 Playbooks", "Entry + Exit Rules", "Common Mistakes"],
    badge: "NEW",
    badgeColor: "#f59e0b",
    badgeBg: "rgba(245,158,11,0.1)",
  },
  {
    ...
    href: "/box-method",
    icon: "📦",
    label: "EDGE Box Method",
    sub: "Range Box · Zone Analysis · Coaching",
    desc: "Interactive box trading analyzer: auto-detects consolidation range box, classifies price into top/middle/bottom zones, identifies breakout/retest/reclaim/rejection setups, confidence scoring, beginner coaching panel with plain-English explanations, and Paper Box Journal.",
    color: "#00d4ff",
    stats: ["Box Detection", "Zone Classification", "Beginner + Advanced"],
    badge: "NEW",
    badgeColor: "#00d4ff",
    badgeBg: "rgba(0,212,255,0.1)",
  },
  {
    ...
    href: "/news-desk",
    icon: "📰",
    label: "EDGE News Desk",
    sub: "Bloomberg-Style Market Intelligence",
    desc: "Categorized financial news across 8 domains: Fed & Rates, Macro, Earnings, Geopolitical, AI/Tech, Energy, Crypto, and Sentiment. Each story includes 'Why It Matters', bull case, bear case, tickers impacted, and risk level — not just headlines.",
    color: "#10b981",
    stats: ["8 Categories", "Bull + Bear Cases", "Risk Levels"],
    badge: "NEW",
    badgeColor: "#10b981",
    badgeBg: "rgba(16,185,129,0.1)",
  },
  {
    ...
    href: "/ipo-radar",
    icon: "🚀",
    label: "EDGE IPO Radar",
    sub: "Pre-IPO Ecosystem · Sympathy Plays",
    desc: "Track public companies positioned around major upcoming IPOs: SpaceX, OpenAI, Stripe, Databricks, Klarna. Sympathy scores, connection type labels (Confirmed/Probable/Thematic), live prices, red-team trap warnings, and IPO news feed.",
    color: "#8b5cf6",
    stats: ["5 IPO Themes", "Sympathy Scoring", "Trap Analysis"],
    badge: "NEW",
    badgeColor: "#8b5cf6",
    badgeBg: "rgba(139,92,246,0.1)",
  },
  {
    ...
    href: "/risk-engine",
    icon: "🛡️",
    label: "EDGE Risk Engine",
    sub: "Position Sizing · R:R · Behavioral Warnings",
    desc: "Institutional-grade position sizing calculator: enter account size, risk %, entry, stop, and targets — get exact share count, dollar risk, exposure %, R:R ratio, and grade (A+–F). Includes behavioral risk checklist and multi-setup comparison table.",
    color: "#f59e0b",
    stats: ["Position Sizing", "R:R Calculator", "Behavioral Checklist"],
    badge: "NEW",
    badgeColor: "#f59e0b",
    badgeBg: "rgba(245,158,11,0.1)",
  },
